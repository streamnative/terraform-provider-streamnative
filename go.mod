...
replace (
	...
	go.etcd.io/etcd/api/v3 => go.etcd.io/etcd/api/v3 v3.6.4
	go.etcd.io/etcd/client/pkg/v3 => go.etcd.io/etcd/client/pkg/v3 v3.6.4
	go.etcd.io/etcd/client/v3 => go.etcd.io/etcd/client/v3 v3.6.4
...
replace github.com/crossplane/crossplane-runtime => github.com/crossplane/crossplane-runtime v0.0.0-20240517192133-88ae9393e6b3

replace github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring v0.74.0 => github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring v0.43.0
...
// pinned to 1.7.3, see: https://cert-manager.io/docs/contributing/importing/#module-import-paths
replace github.com/jetstack/cert-manager => github.com/jetstack/cert-manager v1.7.3
...
replace (
	...
	go.opentelemetry.io/otel/exporters/stdout => go.opentelemetry.io/otel/exporters/stdout v0.21.0
	go.opentelemetry.io/otel/exporters/stdout/stdouttrace => go.opentelemetry.io/otel/exporters/stdout/stdouttrace v1.33.0
)
...
// tagged, so redirect it to the root module.
replace github.com/AliyunContainerService/ack-ram-tool/pkg/credentials/provider => github.com/AliyunContainerService/ack-ram-tool/pkg/credentials/provider v0.19.0
