...
require (
	...
	github.com/streamnative/cloud-cli v0.15.0
...
require (
	...
	github.com/streamnative/cloud-api-server v1.17.1-0.20231211182952-1704c260b408 // indirect
...
replace github.com/onsi/ginkgo/v2 => github.com/onsi/ginkgo/v2 v2.3.1

// OTEL
replace (
	github.com/GoogleCloudPlatform/opentelemetry-operations-go/exporter/trace => github.com/GoogleCloudPlatform/opentelemetry-operations-go/exporter/trace v0.19.0
	github.com/streamnative/kube-instrumentation => github.com/streamnative/kube-instrumentation v0.2.0
	go.opentelemetry.io/contrib/detectors/gcp => go.opentelemetry.io/contrib/detectors/gcp v0.19.0
	go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp => go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp v0.19.0
	go.opentelemetry.io/contrib/propagators/aws => go.opentelemetry.io/contrib/propagators/aws v0.19.0
	...
	go.opentelemetry.io/otel/sdk/trace => go.opentelemetry.io/otel/sdk/trace v0.19.0
	go.opentelemetry.io/otel/trace => go.opentelemetry.io/otel/trace v0.19.0
)

// kubectl
replace (
	golang.org/x/sys => golang.org/x/sys v0.0.0-20211110154304-99a53858aa08
...
replace (
	...
	github.com/streamnative/pulsar-operators/commons/api => github.com/streamnative/pulsar-operators/commons/api v0.17.3
	github.com/streamnative/pulsar-operators/pulsar-operator => github.com/streamnative/pulsar-operators/pulsar-operator v0.17.3
...
replace sigs.k8s.io/apiserver-builder-alpha => github.com/streamnative/apiserver-builder-alpha v0.0.0-20230717175906-0f9240887463 // v1.23.sn
