...
require (
	...
	github.com/opendss/toolkit v0.0.24
	github.com/pkg/errors v0.9.1
	github.com/streamnative/cloud-api-server v1.33.1-0.20250810015514-ee13f2e5648b
...
replace (
	...
	go.opentelemetry.io/otel/exporters/stdout/stdouttrace => go.opentelemetry.io/otel/exporters/stdout/stdouttrace v1.21.0
...
replace (
	...
	github.com/streamnative/sn-operator/api => github.com/streamnative/sn-operator/api v0.9.3
	github.com/streamnative/sn-operator/api/commons => github.com/streamnative/sn-operator/api/commons v0.9.3
	github.com/streamnative/sn-operator/pkg/commons => github.com/streamnative/sn-operator/pkg/commons v0.9.3
)
